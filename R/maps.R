...
#' e.g \code{c(left=150.839539,bottom=-34.024779,right=151.492882,top=-33.757742)}
...
e61_map <- function(bbox=c(left=150.839539,bottom=-34.024779,right=151.492882,top=-33.757742),adjust=0,
                     maptype= "toner-lite"){
  ...
  ggmap <- ggmap::get_stamenmap(bbox=bbox,zoom=zoom,maptype = maptype)
