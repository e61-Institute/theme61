...
#' around the panel, which reads as ink-free in the mask (t61_strip_chrome()
#' keeps that space reserved), same as genuinely empty panel space -- a box
#' can be fully inside the raster while still hanging off the actual
#' plotting area into that gutter, and would render overlapping the real
#' axis text/title once the chrome comes back for the real chart.
#' @noRd
