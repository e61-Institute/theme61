...
save_e61(here::here("man/figures/g-line.svg"))
```

```{r, echo=FALSE}
knitr::include_graphics(here::here("man/figures/g-line.svg"))
```
...
save_e61(here::here("man/figures/g-col.svg"))

```

```{r, echo=FALSE}
knitr::include_graphics(here::here("man/figures/g-col.svg"))
```
...
save_e61(here::here("man/figures/g-scatter.svg"))
```

```{r, echo=FALSE}
knitr::include_graphics(here::here("man/figures/g-scatter.svg"))
```
...
save_e61(here::here("man/figures/g-facet.svg"))
```

```{r, echo=FALSE, out.width='100%'}
knitr::include_graphics(here::here("man/figures/g-facet.svg"))
```
...
save_e61(here::here("man/figures/g-dens.svg"))
```

```{r, echo=FALSE}
knitr::include_graphics(here::here("man/figures/g-dens.svg"))
```
...
### Point range (for regression coefficients) graph {#ptrange}.
...
save_e61(here::here("man/figures/g-ptrg.svg"))
```

```{r, echo=FALSE}
knitr::include_graphics(here::here("man/figures/g-ptrg.svg"))
```
