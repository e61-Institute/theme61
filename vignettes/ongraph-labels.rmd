...
When you have a facetted graph, plot labels will appear on all panels by default unless you use the `panel` argument to specify which panels you want the labels to appear on. 
...
If you want to place the labels on different facets, simply supply a vector of panels in `panel` with which facet you want each label to appear in.
