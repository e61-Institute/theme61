...
knitr::include_graphics(here::here("docs/articles/theme61_files/figure-html/colour-palette-chart-1.png"))
```
...
gg <- 
  ...
  scale_y_continuous_e61(limits = c(0, 100, 25), name = "$b",
                         sec_axis = sec_axis(~sec_rescale(.), name = "$b", labels = c("0.0", "2.5", "5.0", "7.5", ""))) +
  theme_e61() +
