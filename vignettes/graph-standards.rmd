...
```{r}
gg <- ggplot(data_3, aes(x = year, y = value, colour = category)) + geom_line() + theme(legend.position = "bottom")
```
...
gg <- 
  ...
  geom_line(aes(y = sec_rescale_inv(`Personal Care`, scale = 0.1, shift = 0)), colour = e61_palette(2)[[2]]) +
  scale_y_continuous_e61(limits = c(0, 100, 25), name = "$b",
